...
async def master(
    ...
    # 1) Normalizar a WAV limpio (soporta más formatos y evita fallos raros)
    cmd_clean = [
        "ffmpeg", "-y",
        "-hide_banner",
        "-i", str(in_path),
    ...
    # 2) Aplicar preset/filtros al WAV limpio
...
# Sirve tu frontend desde /public (esto va al FINAL para no pisar /api/*)
